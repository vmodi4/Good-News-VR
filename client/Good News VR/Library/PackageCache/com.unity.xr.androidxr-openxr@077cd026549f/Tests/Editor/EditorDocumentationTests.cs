...
namespace UnityEditor.XR.OpenXR.Features.Android.Tests
{
    [TestFixture]
    class EditorDocumentationTests
    {
        /// <summary>
        /// <see cref="PackageManager.PackageInfo"/> for xr.sdk.androidxr-openxr.
        /// </summary>
        ...
        public void SetUp()
        {
            var assembly = Assembly.Load("Unity.XR.AndroidOpenXR");
